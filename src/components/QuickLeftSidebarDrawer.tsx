    ...
    >
        ...
        <div className="flex-1 overflow-y-auto p-4">
          <div className="space-y-4">
            ...
            {/* All Applications */}
            <div>
              <h3 className="text-sm font-semibold text-gray-700 mb-3 uppercase tracking-wide">All Applications</h3>
            ...
            {/* Recent */}
            <div>
              <h3 className="text-sm font-semibold text-gray-700 mb-3 uppercase tracking-wide">Recent</h3>
              <div className="space-y-2">
